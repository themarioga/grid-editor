...
(function($) {
    ...
    $.fn.gridEditor.locales.es = {
        ...
        'tool.text_info': 'Texto: {editor}',
        'tool.delete_text': 'Quitar texto',
        'text.add': 'Texto',
        'text.add_type': 'Texto ({editor})',
        'text.no_editor': 'No hay cargado ningún editor de texto "{type}": este texto se puede mover y borrar, pero no editar',
        ...
        'tool.column_equal': 'Igual: reparte lo que queda de la fila',
        'tool.column_auto': 'Auto: tan ancha como su contenido',
        ...
        'panel.done': 'Hecho',
        'panel.id': 'Id',
        'panel.classes': 'Clases',
        'panel.kind_row': 'Fila',
        'panel.kind_column': 'Columna',
        'panel.kind_text': 'Texto',
        'panel.kind_element': 'Elemento',
        'panel.kind_section': 'Sección',
        'panel.kind_tab': 'Pestaña',
        'panel.kind_accordion_item': 'Elemento de acordeón',
        ...
        'row.add_row_cols': 'Añadir una fila de {columns} columnas, {counts} por fila',
        ...
        'confirm.delete_text': '¿Seguro que quieres borrar este texto?',
        ...
        'utility.col_width': 'Ancho',
        'utility.col_equal': 'Igual',
        'utility.col_auto': 'Auto',
        'section.add': 'Sección',
        'section.width': 'Ancho',
        'section.fixed': 'Fijo',
        'section.fluid': 'Ancho completo',
        'section.from': 'Fijo desde {breakpoint}',
        'tool.add_row_to_section': 'Añadir fila',
        'tool.delete_section': 'Quitar sección',
        'confirm.delete_section': '¿Seguro que quieres borrar esta sección y todo su contenido?',
        'tool.copy': 'Copiar',
        'tool.paste': 'Pegar',
        'clipboard.paste_row': 'Pegar fila',
        'clipboard.paste_section': 'Pegar sección',
        'utility.col_from_row': 'De la fila: {count}',
        'utility.row_cols': 'Columnas por fila',
        'badge.row_cols': '{count} por fila',
        'badge.row_cols_auto': 'Tan anchas como su contenido',
        ...
        'utility.padding': 'Relleno',
        'utility.margin': 'Margen',
        'utility.side_all': 'Todos los lados',
        'utility.side_x': 'Izquierda y derecha',
        'utility.side_y': 'Arriba y abajo',
        'utility.side_t': 'Arriba',
        'utility.side_b': 'Abajo',
        'utility.side_s': 'Inicio',
        'utility.side_e': 'Fin',
        'utility.text_align': 'Alineación del texto',
        'utility.text_start': 'Inicio',
        'utility.text_center': 'Centro',
        'utility.text_end': 'Fin',
        'utility.float': 'Flotar',
        'utility.float_start': 'Inicio',
        'utility.float_end': 'Fin',
        'utility.float_none': 'Ninguno',
        'utility.spacing_gutter': 'El relleno lateral de una columna es su espaciado: cambiarlo cambia el espacio entre columnas',
