...
(function($) {
    ...
    $.fn.gridEditor.locales.es = {
        ...
        'utility.inherit': 'Hereda: {value} (de {breakpoint})',
        'utility.varies': 'Cambia en {breakpoints}; elegir aquí lo sustituye',
        'utility.visibility': 'Visibilidad',
        'utility.visibility_hidden': 'Oculto',
        'utility.visibility_shown': 'Visible',
        'tool.hide_in_view': 'Ocultar en esta vista',
        'tool.show_in_view': 'Mostrar en esta vista',
        'badge.hidden_in': 'Oculto en {breakpoints}',
        'utility.order': 'Orden',
        'utility.order_first': 'Primero',
        'utility.order_last': 'Último',
        'tool.order_earlier': 'Antes en esta vista',
        'tool.order_later': 'Después en esta vista',
        'badge.order': 'Orden: {value}',
        'utility.justify_content': 'Justificar columnas',
        'utility.align_items': 'Alinear columnas',
        'utility.align_self': 'Alinearse',
        'utility.gutters': 'Espaciado entre columnas',
        'utility.gutters_x': 'Espaciado horizontal',
        'utility.gutters_y': 'Espaciado vertical',
