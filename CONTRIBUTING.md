...
* Make sure your pull request is eslint clean by running `npm run lint`. It should report nothing at all, warnings included.
* Make sure the tests still pass by running `npm run build` followed by `npm test`. See BUILDING.md for what they need.
